...
$sql = "SELECT 
    ...
    e.manager_email
FROM departments d
LEFT JOIN employees e ON d.id = e.department_id -- Get all departments with employees through JOIN
ORDER BY d.name ASC, e.name ASC"; -- ORDER BY is used to sort the results by the department name and the employee name
